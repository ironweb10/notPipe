...
1. **Использовать [MX Player](https://archive.org/details/mx-player-1.7.39)** (Android 2.1+) и переключиться на **внешний плеер** в настройках. Правда, на слабых устройствах плеер может лагать на большинстве YouTube-видео. Остаётся только пробовать.
